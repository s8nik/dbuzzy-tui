...
impl CommandRegistry {
    pub fn register() -> Self {
        let commands = vec![
            ...
            Command::new(CmdType::MoveNextWordStart, next_word_start),
            Command::new(CmdType::MoveNextWordEnd, next_word_end),
            Command::new(CmdType::MovePrevWordStart, prev_word_start),
